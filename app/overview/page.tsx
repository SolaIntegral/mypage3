...
const timelineData = {
  ...
  now: [
    ...
    },
    {
      ...
      description: "Y&Y JourneyというBigTechを目指す学生をサポートする団体の運営サポート、クリエイターとしてコンテンツの制作",
      color: "#6366F1",
      details: {
        role: "クリエイター",
        tech: ["Web制作", "コンテンツ制作", "イベント運営"],
        achievements: ["公式HP作成", "イベントLP作成", "運営サポート"],
      },
    },
    {
      id: "google-ai-ambassador-now",
      date: "2025/08-現在",
      title: "Google AI 学生アンバサダー",
      description: "Geminiを学生に広めるための広報活動やイベント運営",
      color: "#4285F4",
      details: {
        role: "イベント企画&運営",
        tech: ["イベント企画", "広報活動", "コミュニティ運営"],
        achievements: ["12月にイベント実施予定", "DevFest出展", "AI技術の普及"],
      },
    },
    {
      id: "gift-app-dev-now",
      date: "2024/08-現在",
      title: "GIFTアプリ開発",
      description: "ギフトを通じて大切な人に健康について考えてもらうサービスの開発",
      color: "#FF6B6B",
      details: {
        role: "開発リーダ、フルスタックエンジニア",
        tech: ["Flutter", "Firebase", "Google Maps API", "フルスタック開発"],
        achievements: ["軽井沢プロジェクト最優秀賞・オーディエンス賞", "AWS地域創生・社会課題解決AIプログラミングコンテスト名古屋大会最優秀賞", "サービス開発継続中"],
      },
    },
  ],
  future: [
    ...
    },
    {
      ...
      details: {
        role: "留学生",
        tech: ["国際経験", "語学習得"],
        achievements: ["グローバル視点", "国際的なネットワーク"],
      },
    },
    {
      id: "product-manager",
      date: "将来",
      title: "Product Manager への転身",
      description: "Software Engineer から Product Manager へのキャリアパス実現",
      color: "#F59E0B",
      details: {
        role: "Product Manager",
        tech: ["プロダクトマネジメント", "ビジネス戦略"],
        achievements: ["プロダクト成功", "ユーザー価値創造", "ビジネス成長"],
      },
    },
  ],
}
